...
This directory contains typed domain models used across the Slugger runtime.
...
- `provider.py` — provider configuration models.
- `execution.py` — runtime execution context and events.
