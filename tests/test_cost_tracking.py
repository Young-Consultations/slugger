...
from observability.cost_tracker import CostTracker, DEFAULT_PRICES
...
def test_cost_by_agent() -> None:
    tracker = CostTracker()
    tracker.record('openai', 'gpt-4o', input_tokens=1000, output_tokens=0, agent_name='req_agent')
    tracker.record('openai', 'gpt-4o', input_tokens=500, output_tokens=0, agent_name='arch_agent')
