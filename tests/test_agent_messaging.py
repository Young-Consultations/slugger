...
def test_publish_to_subscriber(bus: MessageBus) -> None:
    ...
    msg = AgentMessage(sender='architect', recipient='reviewer', subject='review_request')
...
def test_message_payload() -> None:
    msg = AgentMessage(sender='a', recipient='b', subject='handoff', payload={'artifact_id': 'req-1'})
