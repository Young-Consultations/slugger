...
def test_register_creates_v1(registry: PromptRegistry) -> None:
    v = registry.register('req-prompt', 'Requirements Prompt', 'Generate requirements for...')
...
def test_update_bumps_minor_version(registry: PromptRegistry) -> None:
    registry.register('req-prompt', 'Requirements Prompt', 'Generate requirements for...')
    v2 = registry.update('req-prompt', 'Generate detailed requirements for...', change_notes='Added detail')
