...
from observability.dashboard import DashboardSnapshot, FailureAnalytics, MetricsDashboard
...
def test_record_failure(analytics: FailureAnalytics) -> None:
    record = analytics.record('generate_code', 'code_generator_agent', 'timeout', 'Request timed out')
...
def test_dashboard_snapshot_includes_failure_summary(dashboard: MetricsDashboard) -> None:
