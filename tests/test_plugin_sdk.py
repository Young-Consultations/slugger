...
def test_manifest_to_plugin_metadata() -> None:
    manifest = PluginManifest(name='cool-plugin', version='3.0.0', description='Cool',
                               main='cool.Plugin', capabilities=['gen'])
...
def test_manifest_round_trip_dict() -> None:
    manifest = PluginManifest(name='abc-plugin', version='1.0.0', author='Alice',
                               license='Apache-2.0', capabilities=['x'])
